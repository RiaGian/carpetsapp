      ...
      <View style={styles.container}>
        ...
        <View style={styles.filtersSection}>
          ...
          <View style={styles.searchRow}>
            <Ionicons name="search-outline" size={Platform.OS !== 'web' ? 16 : 18} color="#6B7280" />
            <TextInput
        ...
        <Pressable style={StyleSheet.absoluteFill} onPress={onClose}>
          <View style={styles.modalBackdropInner}>
            <Pressable
              ...
              style={Platform.OS !== 'web' ? { width: '100%', alignItems: 'center' } : undefined}
            >
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    color: '#111827',
     ...(Platform.OS !== 'web' && {
    fontSize: 17,     // 👈 πιο μικρό μέγεθος για κινητό
    fontWeight: '500' // 👈 πιο λεπτή γραμματοσειρά
  }),
  },
  filtersSection: {
    marginBottom: 20,
  ...
  searchRow: {
    ...
    ...(Platform.OS !== 'web' && {
    paddingVertical: 6,     // 👈 πιο λεπτό
    paddingHorizontal: 10,
    borderRadius: 10,
    gap: 6,
    minHeight: 36,          // ~ ύψος ~36–38px
  }),
  },
  searchInput: {
    flex: 1,
  ...
  modalTitle: {
    ...
    fontWeight: '600',
    color: '#111827',
    ...(Platform.OS !== 'web' && { fontSize: 16, fontWeight: '400', }),
  },
  modalForm: {
    flex: 1,
    padding: 20,
