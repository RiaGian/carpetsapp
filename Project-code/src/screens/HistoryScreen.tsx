                                    ...
                                    {expandedOrders.map((order) => (
                                      <View key={order.id} style={styles.orderRow}>
                                        ...
                                        <View style={{ marginTop: 6 }}>
                                          ...
                                          {extractAvgPricePerM2(order.notes) && (
                                            <Text style={[styles.rowSub, { color: '#3B82F6', fontWeight: '600', marginTop: 2 }]}>
                                              Τιμή/τ.μ.: {extractAvgPricePerM2(order.notes)} €
                                            </Text>
                                          )}
                                        </View>
              ...
              renderItem={({ item }) => (
                <View style={styles.orderRow}>
                  ...
                  <View style={{ marginTop: 6 }}>
                    ...
                    {extractAvgPricePerM2(item.notes) && (
                      <Text style={[styles.rowSub, { color: '#3B82F6', fontWeight: '600', marginTop: 2 }]}>
                        Τιμή/τ.μ.: {extractAvgPricePerM2(item.notes)} €
                      </Text>
                    )}
                  </View>
                </View>
